...
SWIFT_CLASS("_TtC9ZTCoreKit16BluetoothManager")
...
SWIFT_CLASS("_TtC9ZTCoreKit14DfuSelectModel")
@interface DfuSelectModel : NSObject
...
/// BLE Manager responsible for tracking Bluetooth state and bridging legacy callbacks.
...
/// Instance of a peripheral device (connected or discovered)
...
SWIFT_CLASS("_TtC9ZTCoreKit27ZhortechDeviceSignalManager")
@interface ZhortechDeviceSignalManager : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

SWIFT_CLASS("_TtC9ZTCoreKit21ZhortechSignalManager")
@interface ZhortechSignalManager : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
